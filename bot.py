...
Примечание: выдвигайтесь к планетарному круизному корабль-гранд-отелю! Для перехода на следующее задание поговорите с агентами. Не забудьте ваши билеты - без них вы не сможете попасть на корабль! При заходе на локацию не шумите и не привлекайте лишнее внимание! Для перехода на следующее задание - поговорите с агентами на локации
""", """Задание 6.2"""]
